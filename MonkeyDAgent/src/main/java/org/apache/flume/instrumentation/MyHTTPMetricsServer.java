 ...
 * <p> }
 */
public class MyHTTPMetricsServer implements MonitorService
{

    private Server jettyServer;
    private int port;
    private static Logger LOG = LoggerFactory.getLogger(MyHTTPMetricsServer.class);
    public static int DEFAULT_PORT = 41414;
    public static String CONFIG_PORT = "port";


    public static final int agentId;
    public static JsonNode portInfo;
    static
    {
        try
        {
            ...
            agentId = machinePiece | processPiece;
            //LOG.info("done");
            RestTemplate temp = new RestTemplate();

            portInfo = temp.getForObject("http://master_ip:40999/getPort?agentId="+ agentId, JsonNode.class);

            LOG.info("machine Id: " + Integer.toHexString(agentId) + "portInfo: "+ portInfo);
    ...
    public void start()
    {
        ...
        //TODO 向主机注册,
        if (portInfo.has("monitor_port"))
            port = portInfo.get("monitor_port").asInt();
